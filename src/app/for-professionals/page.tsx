...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return marketingMetadata({
        title: i18n(
            "Riffado for Professionals | Transcription on hardware you control",
        ),
        description: i18n(
...
export default function ForProfessionalsPage() {
    ...
    const onPremisesEmailBody = [
        i18n("Hello,"),
        "",
        i18n("We are exploring an on-premises Riffado setup."),
        "",
        i18n(
        ...
        "",
        i18n("How we record today (devices, roughly how many people):"),
        "",
    ].join("\r\n");
    const onPremisesContact = `mailto:support@riffado.com?subject=${encodeURIComponent(
        i18n("On-premises Riffado setup"),
    )}&body=${encodeURIComponent(onPremisesEmailBody)}`;
    ...
    const ledger: LedgerRow[] = [
        {
            ...
            title: i18n("Capture"),
            body: i18n(
                "Your recorder uploads to your Plaud account, exactly as it does today. Riffado changes nothing about how you record.",
            ),
            holder: i18n("Your recorder → Plaud"),
            holderTone: "external",
        },
        {
            step: "02",
            title: i18n("Sync"),
            body: i18n(
                "Riffado signs into your Plaud account and pulls each new recording down. From this step on, nothing depends on anyone else's cloud.",
            ),
            holder: i18n("You"),
            holderTone: "you",
        },
        {
            ...
            title: i18n("Storage"),
            body: i18n(
                "Audio and transcripts land on your own disk, or in a bucket you own: Cloudflare R2, Backblaze B2, or AWS S3.",
            ),
            holder: i18n("You"),
            holderTone: "you",
        },
        {
            ...
            body: i18n(
                "Whisper runs free in your browser, or Ollama and LM Studio run on your hardware. The audio never leaves the building.",
            ),
            holder: i18n("You"),
            holderTone: "you",
        },
        {
            step: "05",
            title: i18n("Summaries"),
            body: i18n(
                "A local model keeps everything in-house. Or plug in a cloud provider you picked, under your account, your key, your terms.",
            ),
            holder: i18n("You"),
            holderTone: "you",
        },
        {
            ...
            title: i18n("Export"),
            body: i18n(
                "Every transcript in one file: TXT, SRT, VTT, or JSON. Plus a full backup archive. Leaving is a feature, not a negotiation.",
            ),
            holder: i18n("You"),
            holderTone: "you",
        },
    ...
    const workflow: WorkflowBeat[] = [
        {
            step: "01",
            title: i18n("Record like you already do."),
            body: i18n(
                "The recorder in the meeting, the interview, the glovebox. Your capture habits don't change, and the official app keeps working alongside Riffado.",
            ),
        },
        {
            step: "02",
            title: i18n("Transcripts appear without ceremony."),
            body: i18n(
                "Riffado syncs new recordings in the background. Transcribe free with Whisper in your browser, or point it at Ollama on your own machine and let it run unattended.",
            ),
        },
        {
            step: "03",
            title: i18n("Find the sentence. Cite the minute."),
            body: i18n(
                "Search every word you've ever recorded. Player and transcript sit side by side with timestamps intact, and any recording exports as text or subtitles.",
            ),
        },
    ];
    const professions: Profession[] = [
        {
            label: i18n("Lawyers"),
            body: i18n(
                "Client meetings, dictation, matter notes. Run Riffado on office hardware with local transcription, and no new vendor enters the picture between your recorder and your archive. When a client asks where recordings of their matter live, the answer is one sentence: on our machines.",
            ),
        },
        {
            label: i18n("Journalists"),
            body: i18n(
                "Interviews come with promises attached. With local transcription, no transcription service ever holds the tape: the recording syncs to your laptop and the AI runs there too. Search years of interviews without putting a source's voice in someone else's cloud.",
            ),
        },
        {
            label: i18n("Consultants"),
            body: i18n(
                "Engagement notes and client workshops, searchable across every project. When an NDA or a security questionnaire asks where client data goes, you can describe the whole path -- your server, your storage, your model -- without a single ‘it depends.’",
            ),
        },
        {
            label: i18n("Researchers"),
            body: i18n(
                "Participant interviews often come with commitments about where recordings will live. Self-hosting lets you keep those commitments literally: one machine, one storage location, transcription that runs on it. Simple to describe in a data-management plan, simple to verify.",
            ),
        },
    ];
    const boundaries = [
        {
            title: i18n("No compliance certifications."),
            body: i18n(
                "Riffado is not HIPAA or SOC 2 certified, and we won't pretend otherwise. The meaningful claims belong to your setup: your hardware, your AI provider's terms, your policies. We give you the knobs; you own the compliance story.",
            ),
        },
        {
            title: i18n("Capture still passes through Plaud."),
            body: i18n(
                "Your recorder uploads to Plaud's servers before Riffado can sync it. That's how the device works today, with or without us. Once a recording syncs, it lives on storage you control and never depends on Plaud's servers again.",
            ),
        },
        {
            title: i18n("Cloud AI means a cloud provider."),
            body: i18n(
                "If you point transcription at OpenAI or Groq instead of a local model, that provider processes your audio under your account and their terms. Browser Whisper and Ollama exist precisely so you don't have to.",
            ),
        },
        {
            title: i18n("Hosted means trusting us."),
            body: i18n(
                "On Hosted Pro, we operate the storage. It's encrypted at rest and you can export everything at any time, but the trust boundary is us, and we'd rather say so than let you assume otherwise. For maximum control, self-host.",
            ),
        },
        {
            title: i18n("Don't take our word for any of this."),
            body: (
                <>
                    {i18n("Every line of Riffado is AGPL-3.0 on")}{" "}
                    <Link
                    ...
                    {i18n(
                        ". Read it, audit it, or hand it to someone who audits things for a living. The page you're on has to be honest because the code can be checked against it.",
                    )}
                </>
            ),
        },
            ...
            <main className="flex-1">
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-3xl">
                            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs font-mono uppercase tracking-wider mb-6 text-muted-foreground">
                                <span>{i18n("For professionals")}</span>
                                <span
                                    aria-hidden
                            ...
                            <h1 className="text-4xl md:text-5xl font-semibold tracking-tight leading-[1.1] text-balance mb-6">
                                {i18n(
                                    "If your conversations stay in the room, your recordings should too.",
                                )}
                            </h1>

                            <p className="text-lg text-muted-foreground leading-relaxed text-pretty max-w-2xl mb-8">
                                {i18n(
                                    "Client calls, source interviews, engagement notes, field research. Riffado turns the voice recorder you already carry into a transcript archive that runs on hardware you control, transcribed by AI that answers to you, readable by no one you haven't chosen.",
                                )}
                            </p>

                            <div className="flex flex-wrap gap-3">
                                <Link
                                    href={onPremisesContact}
                                ...
                                >
                                    {i18n("Plan an on-premises setup")}{" "}
                            ...
                            <p className="mt-6 text-sm text-muted-foreground">
                                {i18n(
                                    "Works with the Plaud Note family today: Note, Note Pro, and NotePin. More recorders are on the roadmap.",
                                )}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl">
                            <p className="text-sm font-mono text-muted-foreground uppercase tracking-wider mb-4">
                                {i18n("The control model")}
                            </p>
                            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4 text-balance">
                                {i18n("Who holds your words, step by step.")}
                            </h2>
                            <p className="text-muted-foreground text-lg leading-relaxed text-pretty max-w-2xl mb-10">
                                {i18n(
                                    "For professional work, we recommend an on-premises deployment with local AI. We can help you plan and set it up on infrastructure you control. One step still involves a party you didn't choose, and it's the one you already live with.",
                                )}
                            </p>
                            ...
                            <p className="mt-6 text-sm text-muted-foreground leading-relaxed text-pretty max-w-2xl">
                                {i18n(
                                    "Riffado with local AI adds no new third party after your recorder. Prefer a cloud model for speed or quality? Plug in OpenAI or Groq under your own account, and the ledger changes at exactly one step, by your decision.",
                                )}
                            </p>
                        </div>
                    </div>
                ...
                <section className="py-20 md:py-24">
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <p className="text-muted-foreground text-lg leading-relaxed text-pretty max-w-2xl mb-10">
                                {i18n(
                                    "You don't need to become your own infrastructure team. We can configure Riffado, storage, and local AI on your hardware, then leave you with a workflow built for daily use.",
                                )}
                            </p>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl">
                            ...
                            <p className="mt-10 text-sm text-muted-foreground leading-relaxed text-pretty max-w-2xl">
                                {i18n(
                                    "None of this makes compliance automatic. What it makes is a setup simple enough to describe truthfully, which is where every real confidentiality story starts.",
                                )}
                            </p>
                        </div>
                    </div>
                ...
                <section className="py-20 md:py-24">
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-3xl">
                            <p className="text-sm font-mono text-muted-foreground uppercase tracking-wider mb-4">
                                {i18n("Honest boundaries")}
                            </p>
                            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4 text-balance">
                                {i18n("What we don't claim.")}
                            </h2>
                            <p className="text-muted-foreground text-lg leading-relaxed text-pretty mb-10">
                                {i18n(
                                    "You'll be asked hard questions about your setup. Here are the answers we won't dress up.",
                                )}
                            </p>
                ...
                <section className="py-20 md:py-24 border-t border-border/40 bg-secondary/10">
                    <div className="container mx-auto px-4">
                        <div className="mx-auto max-w-4xl">
                            <p className="text-sm font-mono text-muted-foreground uppercase tracking-wider mb-4">
                                {i18n("On-premises, without the setup burden")}
                            </p>
                            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-4 text-balance max-w-2xl">
                                {i18n(
                                    "Keep control of the infrastructure. Let us handle the setup.",
                                )}
                            </h2>
                            <p className="text-muted-foreground text-lg leading-relaxed text-pretty max-w-2xl mb-10">
                                {i18n(
                                    "We can help deploy Riffado on hardware you control, connect your storage and local AI, and prepare the recorder-to-transcript workflow for your practice, newsroom, consultancy, or lab.",
                                )}
                            </p>
                                ...
                                <div className="grid gap-8 md:grid-cols-[1.05fr_1fr] md:gap-10">
                                    <div>
                                        ...
                                        <h3 className="text-xl font-semibold tracking-tight text-balance mb-4">
                                            {i18n(
                                                "An on-premises deployment shaped around your constraints.",
                                            )}
                                        </h3>
                                        <ul className="space-y-2 text-sm text-muted-foreground leading-relaxed">
                                            ...
                                            <li>
                                                {i18n(
                                                    "Storage and local AI configuration",
                                                )}
                                            </li>
                                            <li>
                                                {i18n(
                                                    "Recorder sync and export workflow",
                                                )}
                                            </li>
                                            <li>
                                                {i18n(
                                                    "A clear handoff your team can understand",
                                                )}
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="border-t border-border/60 pt-6 md:border-t-0 md:pt-0 md:border-l md:pl-8 lg:pl-10">
                                        <h4 className="text-sm font-semibold mb-1">
                                            {i18n("Start with one email.")}
                                        </h4>
                                        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                                            {i18n(
                                                "Three things make the first reply useful:",
                                            )}
                                        </p>
                                        <ol className="space-y-2.5 mb-6">
                                            {inquiryPrompts.map((prompt, i) => (
                                                <li
                                                    key={prompt}
                                        ...
                                        >
                                            {i18n("Email us about your setup")}{" "}
                                            <ArrowRight className="size-4" />
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <p className="mt-8 mb-4 text-xs font-mono uppercase tracking-wider text-muted-foreground">
                                {i18n("Two other ways to run Riffado")}
                            </p>
                            <div className="grid gap-4 sm:grid-cols-2">
                                <div className="flex flex-col rounded-xl border border-border bg-card/50 px-5 py-5">
                                    <h3 className="text-sm font-semibold mb-1">
                                        {i18n("Prefer to deploy it yourself?")}
                                    </h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed text-pretty mb-4">
                                        {i18n(
                                            "Riffado is free and open source, with a one-command Docker installer. It's the same deployment we'd set up for you, done at your own pace.",
                                        )}
                                    </p>
                                    <Link
                                ...
                                <div className="flex flex-col rounded-xl border border-border bg-card/50 px-5 py-5">
                                    <h3 className="text-sm font-semibold mb-1">
                                        {i18n("Want us to run it instead?")}
                                    </h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed text-pretty mb-4">
                                        {i18n(
                                            "Hosted Pro runs the same open-source code, with encrypted storage and full export whenever you want to move.",
                                        )}
                                    </p>
                                    <Link
                                        href="/register"
